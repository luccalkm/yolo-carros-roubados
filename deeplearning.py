...
def non_maximum_supression(input_image,detections):
    # FILTRAR DETECTÇÕES BASEADA NA PROBABILIDADE
...
def extract_text(image, bbox):
    ...
    if 0 in roi.shape:
        ...
        custom_config = r'--oem 3 --psm 6 -c tessedit_char_whitelist=AaBbCcDeEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvWwXxYyZz0123456789'
        text = pt.image_to_string(magic_color, config=custom_config)
        text = text.strip()
...
##    MOSTRAR CADA PLACA EM CADA FRAME
## ENDLOOP